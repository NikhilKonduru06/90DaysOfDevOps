## Environment basics
  1. uname -a
     Linux ip-172-31-40-13 6.14.0-1018-aws #18~24.04.1-Ubuntu SMP Mon Nov 24 19:46:27 UTC 2025 x86_64 x86_64 x86_64 GNU/Linux
...
## Filesystem sanity
  ...
  2. cp /etc/hosts /tmp/runbook-demo/hosts-copy && ls -l /tmp/runbook-demo
      output :
            total 4
            -rw-r--r-- 1 ubuntu ubuntu 221 Feb 23 05:42 hosts-copy
...
## Disk / IO
  ...
  2. iostat :
      output :
      Linux 6.14.0-1018-aws (ip-172-31-40-13)         02/23/26        x86_64        (2 CPU)

      avg-cpu:  %user   %nice %system %iowait  %steal   %idle
                 0.28    0.01    0.38    0.31    0.02   99.01
      
      Device             tps    kB_read/s    kB_wrtn/s    kB_dscd/s    kB_read    kB_wrtn    kB_dscd
      loop0             0.03         0.28         0.00         0.00        347          0          0
      loop1             0.12         3.44         0.00         0.00       4271          0          0
      loop2             0.32         1.47         0.00         0.00       1825          0          0
      loop3             0.33         1.49         0.00         0.00       1845          0          0
      loop4             0.05         0.31         0.00         0.00        382          0          0
      loop5             0.51        18.16         0.00         0.00      22547          0          0
      loop6             0.01         0.01         0.00         0.00         14          0          0
      nvme0n1          14.56       248.20        37.11         0.00     308235      46086          0
